		...
		<div class="container-fluid">
			...
			<div class="panel panel-headline">
				...
				<div class="panel-body">
    				...
    				<div class="col-md-12 bottom_text">
    					If you need to re-run these numbers due to a substantial change in your income or expenses, <br />please contact <?php  echo $adviser['first_name']." ".$adviser['last_name']; ?>. <!--at <?php  echo !empty($adviser['phone']) ? $adviser['phone'] : "________________________"; ?> -->
