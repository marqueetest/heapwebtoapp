                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                            <tr>
                                                <td align="left">
                                                    ...
                                                    the plan.</p>
                                                    <p>If you need to re-run these numbers due to a substantial change in your income or expenses, please contact <?php echo $adviser['first_name']." ".$adviser['last_name']; ?>.</p>
                                                    <!--at <?php echo !empty($adviser['phone']) ? $adviser['phone'] : $adviser['email_address']; ?>-->
                                                    <?php
