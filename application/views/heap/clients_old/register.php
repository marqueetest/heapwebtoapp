				...
				<div class="panel-body">
					...
					<form class="form-auth-small" action="" method="post" id="register-client">
						...
						<div class="form-group">
							...
							<input type="email" class="form-control" id="email_address" name="email_address" value="<?php echo set_value('email_address'); ?>" placeholder="xyz@gmail.com" />
						...
						<div class="form-group">
                  			...
                  			<label class="control-label" for="api_access_admin_controll">Approve for Mobile App Use:</label>
                   			...
                   			<input type="checkbox" name="api_access_admin_controll" id="api_access_admin_controll" value="1" <?php echo set_checkbox('api_access_admin_controll', "1") ?> />
