					...
					<table class="table table-striped responsive" id="table-listing">
						...
						<tbody>
							...
							if( !empty( $clients ) ) {
								foreach( $clients as $client ) {
									...
									<tr>
										...
										<td align="center">
											...
											?>
											<a href="<?php echo base_url() ?>client/efpClientChangeStatus/<?php echo $client['userid'] ?>/<?php echo $status?>">
											...
											<div class="btn-group pull-right">
                                               ...
                                               <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle" type="button"><span class="caret"></span></button>
                                               	<ul role="menu" class="dropdown-menu">
													...
													<li><a href="<?php echo base_url() ?>efp-update-client/<?php echo $client["userid"] ?>" class="edit-record">
														<i class="fa fa-pencil"></i> Edit Client
													</a></li>
													<li><a href="<?php echo base_url() ?>client/efpDeleteClient/<?php echo $client['userid'] ?>" class="delete-record" onclick="return confirm('Are you sure you want to delete this client?')">
								...
								?>
								<tr>
									<td colspan="10" align="center">There are no clients added for this advisor!</td>
								</tr>
								<?php
							}
							?>
