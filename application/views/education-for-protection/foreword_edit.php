		...
		<div class="container-fluid">
			...
			<div class="panel panel-headline">
				<div class="panel-heading">
					<h3 class="panel-title">Add / Edit Foreword</h3>
				...
				<div class="panel-body">
					...
					<form class="form-auth-small" action="" method="post" id="heap-landing-page">
						...
						<div class="form-group">
	                      	...
	                      	<div class="form-group">
                           		<textarea name="foreword" id="foreword" class="form-control editor"><?php echo DBout($foreword["foreword"]);?></textarea>
    							<h4><a href="<?php echo base_url() ?>default-foreword/<?php echo $foreword['book_id'];?>" target="_blank">Show Default Foreword</a></h4>
	                      	</div>
	                 	</div>
